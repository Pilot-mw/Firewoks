      ...
      <div style={glassCard}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div onClick={() => document.getElementById('audio-upload').click()} style={fileSelectBox}>
            <span style={{ fontSize: "24px", display: "block", marginBottom: "8px" }}>≡ƒÄ╡</span>
      ...
      <div style={glassCard}>
        ...
        {tracks.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {tracks.map((track) => (
              <div key={track.id} style={listItem}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                  ...
                  <button onClick={() => handleDelete(track.id)} style={deleteBtn}>Delete</button>
                </div>
              </div>
            ))}
          </div>
      ...
      {bookings.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          {bookings.map((booking) => (
            <div key={booking.id} style={listItem}>
              <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                {booking.status === "pending" && (
                  <button onClick={() => updateStatus(booking.id, "confirmed")} style={{ ...actionBtn, background: "#22c55e" }}>Confirm</button>
                )}
                <button onClick={() => deleteBooking(booking.id)} style={deleteBtn}>Delete</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={glassCard}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div onClick={() => document.getElementById('file-upload').click()} style={fileSelectBox}>
            <span style={{ fontSize: "24px", display: "block", marginBottom: "8px" }}>≡ƒôü</span>
...
export default function Admin() {
  ...
  const menuItems = [
    { path: "/admin", label: "Dashboard", icon: "≡ƒôè" },
    { path: "/admin/music", label: "Music", icon: "≡ƒÄ╡" },
    { path: "/admin/bookings", label: "Bookings", icon: "≡ƒôà" },
    { path: "/admin/gallery", label: "Gallery", icon: "≡ƒû╝∩╕Å" },
  ];
  ...
  return (
    <div style={adminContainer}>
      <aside style={sidebar}>
        <div style={logo}>
          <span style={{ color: "#facc15", fontSize: "24px" }}>≡ƒöÑ</span>
        ...
        <div style={sidebarFooter}>
          ...
          <Link to="/" style={backLink}>ΓåÉ Back to Site</Link>
        </div>
      </aside>
